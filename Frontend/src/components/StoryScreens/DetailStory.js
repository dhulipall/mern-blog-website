...
const DetailStory = () => {
  ...
  useEffect(() => {
    ...
    const getDetailStory = async () => {
      ...
      try {
        const { data } = await axios.post(API_URL+ `/story/${slug}`, { activeUser })
        setStory(data.data)
  ...
  const handleLike = async () => {
    ...
    try {
      const { data } = await axios.post(API_URL+ `/story/${slug}/like`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
  ...
  const addStoryToReadList = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(API_URL+ `/user/${slug}/addStoryToReadList`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
            ...
            <div className='Inclusive-detailStory-page'>
                  ...
                  <ul>
                    {story.author &&
                      <li className='story-author-info'>
                        <img src={`https://mern-blog-website-dhsz.onrender.com/userPhotos/${story.author.photo}`} alt={story.author.username} />
              ...
              <div className='story-content' >
                ...
                <div className="story-banner-img">
                  <img src={`https://mern-blog-website-dhsz.onrender.com/storyImages/${story.image}`} alt={story.title} />
